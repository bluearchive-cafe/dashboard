(function (globalObject) {
    ...
    const resolveUidRoute = (href) => {
        ...
        const isCanonicalPath = url.pathname === canonicalPath
            && url.search === ""
            && url.hash === "";
        const isProduction = url.hostname === DASH_HOSTNAME
            || url.hostname === CONTROL_HOSTNAME;
    ...
    const api = { resolveUidRoute };
    globalObject.UidRouting = api;
